/* v1.6.55 production release bootstrap: preserve response tablet fixes while publishing the dispatch editor base-area fix. */
(() => {
  'use strict';
    ...
    const inject = () => {
      ...
      if (game.PTBO_RESPONSE_TABLET?.version !== '1.6.48') {
        ensureScript(
          ...
          new URL('../response-tablet-1.6.48.js?v=1.6.55', location.href).href
        );
      }
      ...
      if (game.PTBO_TABLET_CLOSE_DISPATCH?.version !== '1.6.53') {
        ensureScript(
          ...
          new URL('../tablet-close-dispatch-1.6.53.js?v=1.6.55', location.href).href
        );
      }
      ...
      if (game.PTBO_TABLET_BUTTON_STABILITY?.version !== '1.6.54') {
        ensureScript(
          ...
          new URL('../tablet-button-stability-1.6.54.js?v=1.6.55', location.href).href
        );
      }
