/* v1.6.49 production release bootstrap: hard cache-bust + desktop tablet delivery. */
(() => {
  'use strict';
  ...
  function installDesktopTabletBridge() {
    ...
    const inject = () => {
      ...
      if (doc.getElementById('ptbo-release-tablet-v1649')) return false;

      const script = doc.createElement('script');
      script.id = 'ptbo-release-tablet-v1649';
      script.src = new URL('../response-tablet-1.6.48.js?v=1.6.49', location.href).href;
