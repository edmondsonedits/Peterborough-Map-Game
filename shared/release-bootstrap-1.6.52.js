/* v1.6.52 production release bootstrap: cache-bust + desktop incident tablet delivery. */
(() => {
  'use strict';
  ...
  function installDesktopTabletBridge() {
    ...
    const inject = () => {
      ...
      if (doc.getElementById('ptbo-release-tablet-v1652')) return false;

      const script = doc.createElement('script');
      script.id = 'ptbo-release-tablet-v1652';
      script.src = new URL('../response-tablet-1.6.48.js?v=1.6.52', location.href).href;
