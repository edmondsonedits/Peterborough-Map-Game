(() => {
  ...
  const config={
    ...
    sources:{
      fire:{type:'toronto-fire',url:'https://gis.toronto.ca/arcgis/rest/services/cot_geospatial25/FeatureServer/3',outFields:'ID,ADDRESS,ADDRESS_NUMBER,LINEAR_NAME_FULL,LATITUDE,LONGITUDE,MUNICIPALITY_NAME,STATION'},
      ems:{type:'toronto-paramedic',url:'https://gis.toronto.ca/arcgis/rest/services/cot_geospatial25/FeatureServer/1',outFields:'*'}
    }
  };
