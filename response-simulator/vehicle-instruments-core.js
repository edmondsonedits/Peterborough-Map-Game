(() => {
  ...
  const CONFIG = Object.freeze({
    ...
    lowSpeedTurnDegreesPerFrame: 2.2,
    highSpeedTurnDegreesPerFrame: 0.42,
    steeringReferenceSpeedKmh: 70,
    movementThreshold: 0.00000001,

    directionalDeadzone: 0.18,
    directionalStationaryTurnDegreesPerSecond: 70,
    directionalLowSpeedTurnDegreesPerSecond: 250,
    directionalHighSpeedTurnDegreesPerSecond: 38,
    directionalReferenceSpeedKmh: 70,
    directionalHeadingResponsePerSecond: 13,
