...
(() => {
  ...
  function peterboroughFallback() {
    ...
    const hospital = { id:'prhc', main:'Medical', sub:'Hospital Transport', name:'Peterborough Regional Health Centre', addr:'1 Hospital Drive', lat:44.300744, lng:-78.347467, radius:40, checkpointLat:44.300744, checkpointLng:-78.347467, checkpointRadius:40, areaLat:44.300944, areaLng:-78.347561, areaWidth:58, areaLength:75, areaRotation:88 };
