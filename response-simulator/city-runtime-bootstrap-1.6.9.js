/* Deterministic city runtime bootstrap — v1.6.9.
...
(() => {
  ...
  async function boot() {
    ...
    // service-mode captures the city/config at load time, so deliberately reload it
    // after the authoritative v1.6.9 city package and base store are in place.
