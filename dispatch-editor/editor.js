...
(() => {
  ...
  function exportData(){return {format:'ptbo-location-changes',schema:1,sourceVersion:window.PTBO_BUILD?.version||'1.6.38',dispatchDataVersion:calls.dataVersion,calls:changes.diff(callSeed,normalizeCalls(locations)),bases:changes.diff(bases.getSeed(),bases.getAll()),hospital:changes.diff([bases.getHospitalSeed()],[bases.getHospital()])};}
